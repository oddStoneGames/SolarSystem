...
public:
    unsigned int ID;
    Shader() {}
    // constructor generates the shader on the fly(VS, FS)
    // ------------------------------------------------------------------------
    ...
    // ------------------------------------------------------------------------
    void setVector2(const std::string& name, float value1, float value2) const
    {
    ...
    void checkCompileErrors(unsigned int shader, std::string type, const char* shaderName)
    {
        ...
        if (type != "PROGRAM")
        {
            ...
            if (!success)
            {
                ...
                std::cout << "ERROR::SHADER_COMPILATION_ERROR of type: " << type  << " in " << shaderName << "\n" << infoLog << "\n -- --------------------------------------------------- -- " << std::endl;
            }
        }
        else
        {
            ...
            if (!success)
            {
                ...
                std::cout << "ERROR::PROGRAM_LINKING_ERROR of type: " << type << " in " << shaderName << "\n" << infoLog << "\n -- --------------------------------------------------- -- " << std::endl;
            }
        }
    }
};
